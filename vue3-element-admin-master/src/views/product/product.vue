...
const fetchData = async () => {
  ...
  data.list.forEach(item => {
    item.sliderUrls =  (item.sliderUrls || "").split(',') //item.sliderUrls.split(',')
  })
...
const getById = async id => {
  ...
  //处理图片
  fileList.value = []
  sliderUrlList.value = (product.value.sliderUrls || "").split(',')//product.value.sliderUrls.split(',')
  ...
  //处理详情图片
  detailsFileList.value = []
  detailsImageUrlList.value = (product.value.detailsImageUrls || "").split(',')  //product.value.detailsImageUrls.split(',')
